// Desafio 4: Sistema de Análise de Desempenho de Acionistas
...
class SistemaAcionistas {
    public List<String> obterAnalisesDesempenho(String dataInicialStr, String dataFinalStr) throws ParseException {
        ...
        // Loop para filtrar as análises dentro do período especificado
        for (Analise analise : analises) {
            if (!analise.data.before(dataInicial) && !analise.data.after(dataFinal)) {
                // Se a data da análise estiver dentro do intervalo, adicione à lista filtrada
